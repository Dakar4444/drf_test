...
SECRET_KEY = 'django-insecure-y3!$17h76em#1a*8yd&ogy9wi4s@(5%unx!2qbct+9buvwuc1j'
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': False,                # Генерация нового refresh-токена при обновлении
    'BLACKLIST_AFTER_ROTATION': True,              # Включить черный список для refresh-токенов
